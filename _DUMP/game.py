import pygame
from _DUMP.models import Spaceship, Asteroid, Bullet, Target, Peach
from _DUMP.utils import load_sprite, wrap_position, get_random_position
...
class SpaceRocks:
    ...
    def __init__(self, user_input=True):
        ...
        self.target = Target((1200,800),self.START_CAPTURE_LIFE)

        #inits for cost function
        ...
        for _ in range(0):
            while True:
                ...
                if self.peach:
                    if position.distance_to(self.peach.position) > self.MIN_ASTEROID_DISTANCE:
                        break
