...
from _DUMP.utils import load_sprite, get_random_position, get_random_velocity, wrap_position  # Custom utility functions
...
class Peach(GameObject):
    ...
    def __init__(self, position):
        # Initializing spaceship attributes
        self.direction = Vector2(RIGHT)  # Current direction the spaceship is facing
