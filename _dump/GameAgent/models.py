...
gameAgentPath = os.path.join(os.path.dirname(src_path), 'GameAgent')
...
def text_to_screen(surface, text, pos, size = 20, color = 'white', font_type = os.path.join(gameAgentPath,'assets','fonts','ubuntu.mono.ttf')):
    try: 
        text = str(text)
